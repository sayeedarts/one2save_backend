                ...
                $this->jsonResponse = [
                    ...
                    'data' => [
                        [
                            ...
                            'metadata' => [
                                'title' => limit_text($blogs->name, 110),
                                'description' => limit_text($blogs->content, 110),
            ...
            if (!empty($pageInfo)) {
                $this->jsonResponse = [
                    ...
                    'data' => [
                        ...
                        'metadata' => [
                            'title' => !empty($pageInfo->name) ? limit_text($pageInfo->name, 110) : limit_text($pageInfo->title, 110),
                            'description' => limit_text($pageInfo->content, 110),
